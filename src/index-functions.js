...
let hideCompleted = document.querySelector(".hide-completed-label");
let addNewTodo = document.querySelector(".todo-commands-content-add");
let searchTodo = document.querySelector("#search-todo");
let showAllTodos = document.querySelector(".tasks-nav-button");
let showDeletedTodos = document.querySelector(".deleted-nav-button");
let showCompletedTodos = document.querySelector(".completed-nav-button");
